...
public class Main {
    ...
    public static void main(String[] args) throws SQLException, InterruptedException {
        ...
        List<RunnableOperation> operations1PL = new ArrayList<>(Arrays.asList(
        ...
        List<RunnableOperation> operations2PL = new ArrayList<>(Arrays.asList(
        ...
        new RunnableOperation(c2, 'w', "UPDATE dissheet3 SET name = 'Mickey' WHERE id = 1;"),
         ...
         List<RunnableOperation> operations3PL = new ArrayList<>(Arrays.asList(
         ...
         new RunnableOperation(c1, 'r', "SELECT name FROM dissheet3 WHERE id = 2 FOR UPDATE;"),
         new RunnableOperation(c1, 'w', "UPDATE dissheet3 SET name = 'Mickey' WHERE id = 2;"),
         new RunnableOperation(c1, 'r', "SELECT name FROM dissheet3 WHERE id = 4 FOR UPDATE;"),
         new RunnableOperation(c1, 'w', "UPDATE dissheet3 SET name = 'Truck' WHERE id = 4;"),
         new RunnableOperation(c1, 'c', "COMMIT;"),
         new RunnableOperation(c2, 'r', "SELECT name FROM dissheet3 WHERE id = 4 FOR UPDATE;"),
         new RunnableOperation(c2, 'w', "UPDATE dissheet3 SET name = 'Luigi' WHERE id = 2;"),
         new RunnableOperation(c2, 'w', "UPDATE dissheet3 SET name = 'Mario' WHERE id = 4;"),
         new RunnableOperation(c2, 'c', "COMMIT;"))
 );
        ...
        for (RunnableOperation op : operations3PL) {
